...
public class Account extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ee = v.findViewById(R.id.loginEmail);
        pp = v.findViewById(R.id.loginPassword);

        p =  v.findViewById(R.id.login_password_edit_text);
        e =  v.findViewById(R.id.login_phone_edit_text);
        firebaseAuth = FirebaseAuth.getInstance();
        //initializing views
        Email = v.findViewById(R.id.login_phone_edit_text);
        Password = v.findViewById(R.id.login_password_edit_text);
